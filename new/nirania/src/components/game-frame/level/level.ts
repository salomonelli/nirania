...
class Level {
    ...
    diamonds: number;
    lastDiamond: any;
    opacityHelper: number;
    playSound: boolean;
    instruction: any;
    requiredDiamonds: any;
    collisionDetector: any;
    checkCollisionDetection: boolean = true;
    /**
     * Represents Level
     ...
     */
    checkCollision(protagonist: any) {
     ...
     * @return {Object}
     */
    getCollisionObject(currentPosition: any) {
     ...
     */
    // TODO remove this
    async begin_old(protagonist: any) {
        //reset diamonds
        this.lastDiamond = null;
        this.diamonds = 0;
        //reset way
...
export function getById(id: any, erich: any) {
